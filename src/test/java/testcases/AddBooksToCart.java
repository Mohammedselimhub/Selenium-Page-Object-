...
public class AddBooksToCart extends TestCasesBase {
	...
	public void signupWithExistingUUser() 
	{
		...
		signupPageObject.signupWithAmazonpWithExistEmail("ahmed", "hadymailamazon@gmail.com", "p@ssw0rd10", "p@ssw0rd10");
	}
	...
	{
		signupPageObject = new SignupPage(driver);
		signupPageObject.signupWithAmazonwithdiffrentEmail("ahmed","ahmedqqq@gmail.com" , "p@ssw0rd10", "p@ssw0rd10");
